   ...
   config: {
      ...
      translations: {
         'ru': {
            ...
            "Settings.profile.form.section.password.title": "Сменить пароль",
            "Settings.profile.form.section.profile.title": "Профиль",
