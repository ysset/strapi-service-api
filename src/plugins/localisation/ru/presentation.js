...
module.exports = {
    ...
    CancelInterestButtonDesc:
        'Чтобы не беспокоить по ошибке, у клиента есть возможность отменить заявку. Для этого нужно нажать на кнопку «Отменить заявку»!',
    ...
    cancelFreeTourDescription:
        'Чтобы не беспокоить по ошибке, у клиента также есть возможность отменить заявку. Для этого нужно нажать на кнопку «Отменить заявку»!',
