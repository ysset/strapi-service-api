...
const { userLang, lang } = require('../../../../botUtils/botsLanguages');
...
const commands = {
    ...
    REPEAT_SEARCH_FLATS: async (msg) => {
        ...
        return await commands.SEARCH_FLATS(msg);
    },
    SEARCH_CARS: async (msg) => {
        const chatId = msg.chat.id;
    ...
    REPEAT_SEARCH_CARS: async (msg) => {
        ...
        msg.user = await getUser({ msg });
        return await commands.SEARCH_CARS(msg);
    },
    inlineCallBacks: {
        NEXT: async (query) => {
